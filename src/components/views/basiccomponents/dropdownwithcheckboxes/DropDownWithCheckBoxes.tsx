...
export default function DropDownWithCheckBoxes(props) {
    ...
    const toggleOptionCheck = (extraId: string) => {
        props.toggleOptionCheck(extraId);
    };
                            ...
                            <ClickAwayListener onClickAway={handleClose}>
                                <MenuList id="split-button-menu" autoFocusItem>
                                    {props.options ? props.options.map((option, index) => (
                                        ...
                                        >
                                            <FormControlLabel control={<Checkbox onChange={() => toggleOptionCheck(option.id)} checked={props.checkedItemsIds.includes(option.id)} />} label={option.name} className="dayCheckBox" />
                                        </MenuItem>
                                    )) : <MenuItem
                                        className={classes.ulLi}>
